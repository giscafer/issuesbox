...
exports.staticalIssues = staticalIssues;
...
function dataHandler(issues) {
    ...
    try {
        var _loop = function _loop() {
            ...
            var arr = _.filter(issues, function (issue) {
...
function init() {
    ...
    if (!(0, _util.isGitlab)()) return;

    console.log('gitlab site');

    if (!(0, _util.isIssuesPage)()) return;
...
},{"./issues":2,"./util":4}],4:[function(require,module,exports){
'use strict';
...
exports.isIssuesPage = isIssuesPage;
